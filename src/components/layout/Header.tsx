  ...
  return (
    <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-4xl px-4">
      <div className="container flex h-16 items-center justify-center p-0">
        ...
        {/* Mobile Cart - Positioned absolutely or separate from nav */}
        {isClient && isMobile && (
          <div className="absolute right-4 top-1/2 -translate-y-1/2 md:hidden bg-background/80 backdrop-blur-sm rounded-full">
            <CartSidebar />
          </div>
        )}
      </div>
